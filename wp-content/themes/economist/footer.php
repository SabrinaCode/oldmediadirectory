...
var EcontestURLpath =EcontestURL.split('/');
  s.pageName="other|other|media_directory";  // use name that reflect the content
if(EcontestURLpath[2]){
s.pageName="other|other|media_directory_"+EcontestURLpath[2].replace(/-/gi, "_");
  }
s.pageType="";
s.server="economist.com";
s.channel="other";
s.prop1="media_directory";
s.prop3="web";
s.prop4="other";
//s.prop34="econfinal";// for mobile site set value to econmobile

  /************* DO NOT ALTER ANYTHING BELOW THIS LINE ! **************/
var s_code=s.t();if(s_code)document.write(s_code)//-->
<!-- <!-- Delete this comment start --></script>
<script language="JavaScript" type="text/javascript"><!--
